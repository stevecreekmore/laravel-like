# enable a user to like another user
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-like.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-like)
...
```bash
php artisan vendor:publish --tag="laravel-like-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-like-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-like-views"
```

## Usage

```php
$laravelLike = new stevecreekmore\LaravelLike();
echo $laravelLike->echoPhrase('Hello, stevecreekmore!');
```
